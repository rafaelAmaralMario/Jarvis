...
- `09:15` — **Card `021_BackgroundAgents`** → **Done**: `BackgroundAgentManager` com `TaskScheduler` + `DirectoryWatcher`, git log check e workspace cleanup agents, fila de notificações, `list_agents`/`agent_log` tools. Notificações frontend postergadas. Kanban: **Backlog 0, Done 37, Removed 2**.
