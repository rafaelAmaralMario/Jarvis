...
Esta pasta contem as definicoes do projeto antes e durante o desenvolvimento.
...
- [Interface e Layout](interface-layout.md)
- [Seguranca e Permissoes](seguranca-permissoes.md)
- [Agentes](agentes.md)
- [Plugins](plugins.md)

## Decisoes Arquiteturais

- [ADR 0001 - Usar Tauri](adr/0001-usar-tauri.md)
